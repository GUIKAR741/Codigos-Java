...
import br.com.guikar.netbeans.ufc.poo.eclusa.model.Container;
import br.com.guikar.netbeans.ufc.poo.eclusa.model.*;
import br.com.guikar.netbeans.ufc.poo.eclusa.view.CaixaView;
import br.com.guikar.netbeans.ufc.poo.eclusa.view.EclusaView;
...
public class EclusaController {
    ...
    public void trocaImagem(JLabel label, String end) {
        ImageIcon image = new ImageIcon(getClass().getResource("/br/com/guikar/netbeans/ufc/poo/eclusa/images/" + end));
